                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent('transferButton_navigate_to');
                            ...
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent('activityButton_navigate_to');
                            ...
                            children: [
                              Padding(
                                ...
                                child: FaIcon(
                                  ...
                                  color:
                                      FlutterFlowTheme.of(context).imperialRed,
                                  size: 40,
                                ),
                              ),
                              Expanded(
                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: FaIcon(
                                  FontAwesomeIcons.exclamationCircle,
                                  color: FlutterFlowTheme.of(context).orangeRed,
                                  size: 40,
                                ),
                              ),
                              Expanded(
                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                ...
                                child: FaIcon(
                                  FontAwesomeIcons.exclamationCircle,
                                  color: FlutterFlowTheme.of(context).jonquil,
                                  size: 40,
                                ),
                              ),
                              Expanded(

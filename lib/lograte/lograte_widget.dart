...
class LograteWidget extends StatefulWidget {
  const LograteWidget({Key? key}) : super(key: key);

  @override
  _LograteWidgetState createState() => _LograteWidgetState();
}

class _LograteWidgetState extends State<LograteWidget>
